...
export default function Categories() {
	return (
		<section id="categories" className={styles.section} aria-labelledby="cat-title">
			<div className="container">
				...
				<ul className={styles.grid}>
					{categories.map((c) => (
						<li key={c.name}>
							<Link href={c.href} className={`${styles.card} surface-card`}>
								...
								<p className={`${styles.blurb} text-muted`}>
									{c.blurb}
								</p>
